...
import style from './En.module.scss';

type Props = {}

export const En: React.FC<Props> = () => {
  return (
    <svg
      viewBox="0 0 256 256"
    ...
    >
      ...
      >
        ...
        <path
          ...
          transform=" matrix(1 0 0 1 0 0) "
          strokeLinecap="round" />
        <path d="M 7.8 70.321 L 28.422 60.01 H 15.01 L 4.758 65.136 C 5.661 66.936 6.674 68.67 7.8 70.321 z"
          className={style.p_2}
          transform=" matrix(1 0 0 1 0 0) "
          strokeLinecap="round" />
        <path
